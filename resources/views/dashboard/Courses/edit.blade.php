                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> تعديل {{ $course->name}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.courses.update', $course->id)}}" method="POST"
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="text-center">
                                            <img src="{{ $course->image}}" alt="" class="rounded-circle height-150">
                                        </div>
                                        <div class="form-group">
                                            <label> صوره  </label>
                                       ...
                                       <div class="row">
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="form-group">
                                               ...
                                               <input type="number" name="price" id="price"  step="1"  class="form-control"placeholder="enter price" value="{{$course->price}}">
                                               @error("price")
                                               <span class="text-danger"> {{$message}}  </span>
                                               @enderror
                                            </div>
