                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item  "><a href="{{route('admin.courses.create')}}">اضافه كورس </a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table
                                           ...
                                           @foreach ($courses as $index => $course)
                                              <tr>
                                                  ...
                                                  <td>{{ $index+1 }}</td>
                                                  <td><img style="width:50px;height:50px;" src="{{ $course->image}}" alt=""></td>
                                                  <td>{{ $course->name}}</td>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{ route('admin.courses.destroy', $course->id)}}"  class="btn btn-outline-danger btn-sm box-shadow-3 mr-1 mb-1">حذف</a>
